...
export const buttonsVariants = cva(
  "focus-state inline-flex items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-medium transition-colors disabled:pointer-events-none",
  {
    variants: {
      variant: {
        neutral:
          "bg-neutral-50 text-neutral-900 shadow-innerShadowLight ring-amber-500 ring-offset-neutral-300 hover:bg-neutral-100 dark:bg-neutral-950  dark:text-neutral-100 dark:shadow-innerShadowDark dark:ring-offset-neutral-900 dark:hover:bg-neutral-900",
